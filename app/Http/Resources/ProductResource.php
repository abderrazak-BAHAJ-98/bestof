...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
                ...
                'p_slug'=>$this->p_slug,
                'p_description'=>$this->p_description,
                'p_image_1'=>asset('/product-img/'.$this->p_image_1),
                'p_image_2'=>asset('/product-img/'.$this->p_image_2),
                'p_image_3'=>asset('/product-img/'.$this->p_image_3),
                'p_image_4'=>asset('/product-img/'.$this->p_image_4),
                'p_color'=>$this->p_color,
                'p_price'=>(string)$this->p_price,
            ];
    }
