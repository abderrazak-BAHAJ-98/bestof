...
export default {
  ...
  async created(){
    ...
    if(this.userHasAuth){
      this.$store.dispatch('getCardsUser',null,{root:true})
      this.$store.dispatch('getCartsUser',null,{root:true})
      this.$store.dispatch('getFavorites',null,{root:true})
    }
    
    
  },
  computed:{
      ...mapGetters(['hasError','userHasAuth'])
    }
}
</script>
